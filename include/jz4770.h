...
#define REG_LVDS_TXCTRL (*(volatile unsigned int *)0xb30503c0)
#define REG_LVDS_TXPLL0	(*(volatile unsigned int *)0xb30503c4)
#define	REG_LVDS_TXPLL1 (*(volatile unsigned int *)0xb30503c8)
...
#define CPM_PCMCDR_PCMPCS		(1 << 30) /* 0:PLL0 1:PLL1 clock output */
...
#define LCD_CTRL_BST_MASK	(0x07 << LCD_CTRL_BST_BIT)
  ...
  #define LCD_CTRL_BST_C16	(5 << LCD_CTRL_BST_BIT) /* C16-word */
