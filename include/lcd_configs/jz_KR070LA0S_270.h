...
/*
 * kernel/drivers/video/panel/jz_KR070LA0S_270.c -- Ingenic LCD panel device
 */

#ifndef __JZ__KR070LA0S_270_H__
#define __JZ__KR070LA0S_270_H__
#include <serial.h>
#include <common.h>
#include <config.h>
...
static void KR070LA0S_270_lvds_config(void)
{
...
*/
	/*
		...
		[Read][130503c4]:       0x80001304
		[Read][130503c8]:       0x81000000
	*/
}

static void KR070LA0S_270_lvds_on(void)
{
//	KR070LA0S_270_lvds_config();
	REG_LVDS_TXCTRL |= 0x1;
	serial_puts_msg("KR070LA0S_270_lvds_on\n");
}

static void KR070LA0S_270_lvds_off(void)
{
	REG_LVDS_TXCTRL &= ~0x1;
	serial_puts_msg("KR070LA0S_270_lvds_off\n");
}
