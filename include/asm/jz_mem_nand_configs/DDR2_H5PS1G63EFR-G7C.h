...
#define DDR_tRP  14  /* tRP: PRECHARGE command period to the same bank */
#define DDR_tRCD 14  /* ACTIVE to READ or WRITE command period to the same bank. */
#define DDR_tRC  59  /* ACTIVE to ACTIVE command period to the same bank.*/
...
#define DDR_tXP 3    /* tCK EXIT-POWER-DOWN to next valid command period: 1 to 8 tCK. */
