...
#define DDR_BANK8_1 1 	/* Banks each chip: 0-4bank, 1-8bank */
...
#define DDR_tRRD MAX(5, 7500) /* ACTIVE bank A to ACTIVE bank B command period. DDR3 - tCK*/
#define DDR_tRTP MAX(5, 7500) /* READ to PRECHARGE command period. DDR3 spec no. 7.5ns*/
#define DDR_tWTR MAX(5, 7500) /* WRITE to READ command delay. DDR3 spec no. 7.5 ns*/
