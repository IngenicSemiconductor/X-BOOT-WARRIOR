...
#define USB_FILTER 32
#define DC_FILTER 64
#define DC_USB_FILTER 68
...
#include "asm/jz_mem_nand_configs/DDR3_H5TQ2G83CFR.h"

/* NAND FLASH chip*/
#include "asm/jz_mem_nand_configs/NAND_K9K8G08U0D.h"
...
//#define CFG_CORE_VOLTAGE 1300 //1350
 ...
 * Battery  QYANG
 */
#define GPIO_OTG_ID_PIN		(32*4+2)  /*PE2  */
...
#define LCD_PWM_PERIOD		100000	/* pwm period in ns */
...
#define LCD_VCC_EN      	(32*5 + 10)        	/*PB23*/
...
#define GPIO_LCD_DISP_N 		(32*5 + 11)        /*LCD_DISP_N use for lcd reset*/
...
#define GPIO_BL_POWER         (32*1 + 23)

#define GPIO_USB_ID			(32 * 4 + 2)	/*PE2*/
