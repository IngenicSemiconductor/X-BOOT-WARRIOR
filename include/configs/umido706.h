...
#define CONFIG_BOOTARGS		"mem=224M@0x0 mem=120M@0x30000000 console=ttyS2,57600n8 ip=off root=/dev/ram0 rw rdinit=/init memcfg=512M"
 ...
 * Nand Partition info
 */
//board umido706 is not support nand boot
...
#define GPIO_KEY_MAIN			(32*3 + 19)/*GPE24 MAIN*/
#define GPIO_KEY_VOLUME_INC		(32*3 + 17) /*GPE25 */

#define GPIO_KEY_VOLUME_DEC		(32*3 + 18)/*GPD18 SW6*/
#define GPIO_KEY_BACK			(32*4 + 25)/*GPD17 BOOT_SEL0*/
#define GPIO_KEY_MENU			(GPIO_KEY_MAIN)/*GPE26 MSC0_D6/MSC1_D6/MSC2_D6*/
#define GPIO_KEY_BOOT			(GPIO_KEY_BACK)/*GPD17 BOOT_SEL0*/

#define GPIO_CHARGE_DETECT		(32*2 + 31)/*GPD26 PS2_KCLK*/
#define GPIO_CHARGE_LEVEL		(1)

#define GPIO_USB_DETECT			(32*5 + 5)/*GPB5*/
#define GPIO_USB_INSERT_LEVEL	(1)

#define GPIO_DC_DETECT			(32*5 + 5)/*GPF5*/
#define GPIO_DC_INSERT_LEVEL	(1)

#define GPIO_AMP_ENABLE			(32*5 + 20)/*GPF11*/
#define GPIO_AMP_MUTE_LEVEL		(1)

#define GPIO_HP_DETECT			(32*5 + 21)/*GPB23 TSD3*/
 ...
 * Battery  QYANG
 */
#define GPIO_OTG_ID_PIN		(GPIO_USB_DETECT)  /*PD7  */
#define GPIO_CHARG_DETE_N   (GPIO_CHARGE_DETECT)  /* PF2*/
...
#define __battery_is_charging() (!__gpio_get_pin(GPIO_CHARG_STAT_N)&&__dc_detected())
...
#define __recovery_keys_presed() 		(0)//(!__gpio_get_pin(XBOOT_SEL_RCVR_KEY))
