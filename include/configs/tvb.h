...
#define CONFIG_BOOTARGS		"mem=208M@0x0 mem=128M@0x30000000 console=ttyS2,57600n8 ip=off root=/dev/ram0 rw rdinit=/init memcfg=512M"
 ...
 * Nand Partition info
 */
//board tvb is not support nand boot
...
#define GPIO_HDMI_RST_N				(32 * 4 + 12)//GPE12  /* HDMI reset, active low */
#define GPIO_HDMI_INT_N				(32 * 5 + 19)//GPF19  /* HDMI interrupt, active low */
#define GPIO_HDMI_HPD				(32 * 3 + 19)//GPD19  /* HDMI Hot Plug Detection */
