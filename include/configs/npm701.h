...
#define	CFG_DIV_FREQ_V0		DIV(1,6,6,3,6,3)
#define	CFG_DIV_FREQ_V1		DIV(1,4,8,2,4,4)
#define CFG_CPU_SPEED_2_V1  (1200 * 1000000)
#define CFG_CPU_SPEED_2_V0  (1200 * 1000000)
...
//#define CONFIG_BOOTARGS		"mem=256M@0x0 console=ttyS2,57600n8 ip=off root=/dev/ram0 rw rdinit=/init memcfg=256M"
...
//#define CONFIG_BOOTARGS		"mem=224M@0x0 console=ttyS2,57600n8 ip=off root=/dev/ram0 rw rdinit=/init memcfg=512M"
 ...
 * Nand Partition info
 */
//board npm701 is not support nand boot
...
#define GPIO_CHARG_DETE_N   (32*5+14)	/* PD6*/
...
#define __get_key_status() (__gpio_get_pin(PWR_WAKE)&&__gpio_get_pin(VOL_ADD)&&(!__gpio_get_pin(VOL_SUB)))
