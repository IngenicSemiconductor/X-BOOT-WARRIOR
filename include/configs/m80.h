...
#define USB_FILTER 80
#define DC_FILTER 148
#define DC_USB_FILTER 152
#define LOW_BATTERY_MIN 3500 
...
/*disbale framebuffer console and enbale ttyS3*/
...
/*enable framebuffer console and disable ttyS3*/

/* disable both framebuffer console and ttyS3 */
//#define CONFIG_BOOTARGS		"mem=256M@0x0 mem=752M@0x30000000 ip=off root=/dev/ram0 rw rdinit=/init pmem_camera=16M@0x5f000000"

/* enable both */

#if  defined(CONFIG_MSC_TYPE_MMC)
#define CONFIG_BOOTARGS     "mem=256M@0x0 mem=752M@0x30000000 console=tty0 fbcon=rotate:1 console=ttyS3,57600n8 ip=off root=/dev/ram0 rw rdinit=/init pmem_camera=16M@0x5f000000"
#else
#define CONFIG_BOOTARGS		"mem=256M@0x0 mem=752M@0x30000000 console=tty0 fbcon=rotate:1 ip=off root=/dev/ram0 rw rdinit=/init pmem_camera=16M@0x5f000000 rootdelay=2"
#endif
...
#else
#define GPIO_KEY_VOLUME_INC		(32*3 + 17) /* vol+ K4 */
#endif
...
#define ACT8600_LDO_HDMI_1_8  ACT8600_LDO7_VOLTAGE_SET
#define ACT8600_LDO_HDMI_3_3  ACT8600_LDO8_VOLTAGE_SET
#define ACT8600_LDO_LCD_3_3   ACT8600_LDO8_VOLTAGE_SET
#define ACT8600_HDMI_1_8 ACT8600_1_8
#define ACT8600_HDMI_3_3 ACT8600_3_3
#define ACT8600_LCD_3_3  ACT8600_3_3
/*======================================================================
* LCD backlight
*/
#define LCD_PWM_CHN             0	/* pwm channel */
#define LCD_PWM_FULL            256
#define DEFAULT_BACKLIGHT_LEVEL 48
...
#define LCD_RESET_PIN   	(32*1 + 22)      	/*PB22*/
#define LCD_VCC_EN      	(32*1 + 23)        	/*PB23*/
...
#define GPIO_LCD_RST        LCD_RESET_PIN
...
#define GPIO_USB_ID			(32 * 4 + 30)	/*PE11*/
