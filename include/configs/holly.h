...
/* DDR chip */
#include "asm/jz_mem_nand_configs/MDDR_H9DP32A4JJACGR.h" /* 512M */
...
#define CFG_DIV_FREQ        DIV(1,6,6,3,6,3)
#define CFG_CPU_SPEED_1		(600 * 1000000)		    /* CPU clock */
...
#define	CFG_PROMPT		"HOLLY # "	/* Monitor Command Prompt    */
 ...
 * Nand Partition info
 */
//board holly is not support nand boot
