...
#include "asm/jz_mem_nand_configs/DDR3_K4B4G0846BHCK0.h"
...
#define CFG_CPU_SPEED		(800 * 1000000)           //mpll
#define CFG_MEM_SPEED		CFG_CPU_SPEED           //mpll
//#define CFG_DIV                 6               /* for ddr div */
#define CFG_DIV                 4               /* for ddr div */
#define CFG_DDR_SPEED		(CFG_MEM_SPEED / CFG_DIV * 1000000)           //mpll

#define	CFG_HZ			(CFG_EXTAL/256) 	        /* Incrementer freq */

#define GFG_AUDIO_SPEED		(204 * 1000000)			//epll
...
#define CFG_NAND_ZIMAGE_OFFS	(CFG_NAND_BLOCK_SIZE*4) /* NAND offset of zImage being loaded */ //unclock for captain
...
//board npm702 is not support nand boot
#define KERNEL_NAND_START  16
#if (KERNEL_NAND_START == 8) // start from 8M
...
#elif (KERNEL_NAND_START == 16)
#define PTN_BOOT_OFFSET            (  16 * 0x100000)
#define PTN_BOOT_SIZE              (  16 * 0x100000)
#define PTN_RECOVERY_OFFSET        (  32 * 0x100000)
#define PTN_RECOVERY_SIZE          (  16 * 0x100000)
#define PTN_MISC_OFFSET            (  48 * 0x100000)
#define PTN_MISC_SIZE              (   4 * 0x100000)
#define PTN_BATTERY_OFFSET         (  52 * 0x100000)
#define PTN_BATTERY_SIZE           (   1 * 0x100000)
#endif
 ...
 * GPIO
 */
#define __GPIO_A(num) (32 * 0 + num)
#define __GPIO_B(num) (32 * 1 + num)
#define __GPIO_C(num) (32 * 2 + num)
#define __GPIO_D(num) (32 * 3 + num)
#define __GPIO_E(num) (32 * 4 + num)
#define __GPIO_F(num) (32 * 5 + num)
#define __GPIO__(group, num)  __GPIO_##group (num)

#define INVALID_PIN  			(32*3 + 4)         /* GPD4 UART3_RTS_N */
#define NULL_PIN 				INVALID_PIN
#define GPIO_NULL				NULL_PIN

/* Support for simulation button using GPIO.
 * The CYCLE_BEGIN_PIN begin simulation button;
 * The CYCLE_STOP_PIN stop simulation button.
 */
#define CYCLE_BEGIN_PIN	  (1 * 32 + 3)	//Begin_Key,PF9, KEY0
#define CYCLE_STOP_PIN	(1 * 32 + 4)	//Stop_Key, PF10, KEY1
...
#define GPIO_KEY_MAIN			(32*5 + 10)/*GPF10 MAIN*/
#ifdef CONFIG_NPM702_V_1_1
#define GPIO_KEY_VOLUME_INC		(32*2 + 28) /* vol+ K4 */
#else
#define GPIO_KEY_VOLUME_INC		(32*2 + 28) /* vol+ K4 */
#endif

#define GPIO_KEY_VOLUME_DEC		GPIO_BOOT_SEL1/*vol- K3 */
#define GPIO_KEY_BACK			(32*5 + 9)/*GPF9 BOOT_SEL0-------captain*/
#define GPIO_KEY_MENU			(GPIO_KEY_MAIN)/*GPF10 MSC0_D6/MSC1_D6/MSC2_D6*/
#define GPIO_KEY_BOOT			(GPIO_KEY_BACK)/*GPD17 BOOT_SEL0*/

#define GPIO_CHARGE_DETECT		(32*1 + 3)	/*GPB3 */
#define GPIO_CHARGE_LEVEL		(0)

#define GPIO_USB_DETECT			(32*5 + 13)	/*GPF13----captain*/
#define GPIO_USB_INSERT_LEVEL	(0)

#define GPIO_DC_DETECT			(32*4 + 3)	/*GPE3*/
#define GPIO_DC_INSERT_LEVEL	(1)

#define GPIO_AMP_ENABLE			(32*4 + 6)/*GPE6*/
#define GPIO_AMP_MUTE_LEVEL		(0)

//#define GPIO_HP_DETECT			(32*1 + 23)/*GPB23 TSD3*/
//#define GPIO_HP_DETECT			(32*4 + 9)/*GPE9 TSD3-----captain*/
//#define GPIO_HP_INSERT_LEVEL	(0)

#define GPIO_HP_MUTE			(32*3 + 13)/*GPD13 UART1_RTS*/
...
#define GPIO_GSENSOR_INT1		-1	//(32*5 + 20)/*GPF20 PS2_MDATA*/
#define GPIO_GSENSOR_INT2		-1	//(32*5 + 19)/*GPF19 PS2_MCLK*/

#define GPIO_CTP_INT			(32*5 + 19)/*GPF19 MSC1_D0*/
#define GPIO_CTP_WAKEUP			(32*5 + 18)/*GPF18 MSC1_D1*/

#define GPIO_BT_RESET			(32*5 + 8)/*GPF8 MSC1_CMD*/
#define GPIO_BT_RESET_LEVEL		(0)

#define GPIO_BT_INT			(32*5 + 6)/*GPF6 DACK1*/
#define GPIO_BT_WAKEUP			(32*5 + 5)/*GPF5 DREQ1*/

#define GPIO_BT_POWER			(32*5 + 7)/*GPF7*/
#define GPIO_BT_POWER_LEVEL		(1)

//#define GPIO_WLAN_POWER			(32*5 + 7)/*GPF7*/
#define GPIO_WLAN_POWER			(32*3 + 8)/*GPD8*/
#define GPIO_WLAN_POWER_LEVEL	(1)

#define GPIO_WLAN_RESET			(32*3 + 24)/*GPD24 MSC1_CLK*/
#define GPIO_WLAN_RESET_LEVEL	(0)

#define GPIO_WLAN_INT			(32*5 + 7)/*GPF7 DREQ0*/
#define GPIO_WLAN_WAKEUP		(32*3 + 9)/*GPD9 DACK0*/
...
//#define XBOOT_SEL_FAST_KEY             (32 * 5 + 10) //captain
#define XBOOT_SEL_FAST_KEY             __GPIO__(B, 4)
...
//#define GPIO_SDA        (32 * 4 + 30)   //GPD30
//#define GPIO_SCL        (32 * 4 + 31)    //GPD31

#define GPIO_I2C0_SDA        (32 * 3 + 30)   //GPD30
#define GPIO_I2C0_SCL        (32 * 3 + 31)    //GPD31

#define GPIO_SDA              GPIO_I2C0_SDA
#define GPIO_SCL              GPIO_I2C0_SCL

#define GPIO_I2C1_SDA        (32 * 4 + 30)   //GPE30
#define GPIO_I2C1_SCL        (32 * 4 + 31)    //GPE31

#define GPIO_I2C3_SDA       -1	// (32 * 3 + 10)   //GPD10
#define GPIO_I2C3_SCL       -1	//(32 * 3 + 11)    //GPD11
...
#define LCD_PWM_PERIOD		5000000	/* pwm period in ns */
#define PWM_BACKLIGHT_CHIP	1	/*0: digital pusle; 1: PWM*/
/*======================================================================
 * gpio for lcd
 */
#define LCD_PWM_PIN		(32*4 + 0)			/*PE0*/
//#define LCD_PWM_PIN		(32*4 + 9)			/*PE0*/
...
//#define LCD_RESET_PIN   	(32*3 + 11)      	/*PE11----captain*/
#define LCD_RESET_PIN   	__GPIO__(F, 14)
//#define LCD_VCC_EN      	(32*4 + 9)        	/*PE9----captain*/
#define LCD_VCC_EN      	__GPIO__(B, 23)        	/*PB23----captain*/
...
#define GPIO_LCD_DISP_N 		LCD_RESET_PIN        /*LCD_DISP_N use for lcd reset*/
...
#define GPIO_FVDD_EN			(32 * 5 + 20)/*GPF20----captain*/
