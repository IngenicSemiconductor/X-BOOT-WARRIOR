...
//#include "asm/jz_mem_nand_configs/DDR2_H5PS1G831CFP-S6.h" /* 512M */
...
//#define CFG_CPU_SPEED		(1056 * 1000000)		    /* CPU clock */
...
//#define BORDER_REG_DDRC_PMEMCTRL2 0x8022
 ...
 * Nand Partition info
 */
//board ps47 is not support nand boot
...
#define GPIO_KEY_MAIN			INVALID_PIN/*GPE24 MAIN*/
#define GPIO_KEY_VOLUME_INC		(32*4 + 24) /* vol+ K4 */

#define GPIO_KEY_VOLUME_DEC		GPIO_BOOT_SEL1/*vol- K3 */
#define GPIO_KEY_BACK			INVALID_PIN/*GPD17 BOOT_SEL0*/
#define GPIO_KEY_MENU			(GPIO_KEY_MAIN)/*GPE26 MSC0_D6/MSC1_D6/MSC2_D6*/
#define GPIO_KEY_BOOT			(GPIO_KEY_BACK)/*GPD17 BOOT_SEL0*/

#define GPIO_CHARGE_DETECT		(32*2 + 31)/*GPC31*/
...
#define GPIO_HP_DETECT			(32*1 + 21)/*GPB23 TSD3*/
#define GPIO_HP_INSERT_LEVEL	(0)

#define GPIO_HP_MUTE			INVALID_PIN/*GPB29 UART1_RTS*/
 ...
 * Battery  QYANG
 */
#define GPIO_OTG_ID_PIN		(32*5+18)  /*PD7  */
...
#define GPIO_SDA        (32 * 3 + 5)   /* GPE25 */ 
#define GPIO_SCL	(32 * 3 + 4)	/* GPE28 */ 
...
#define LCD_VCC_EN      	(32*4 + 13)        	/*PB13*/
