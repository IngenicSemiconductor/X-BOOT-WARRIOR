...
//#include "asm/jz_mem_nand_configs/NAND_MT29F128G08CFABA.h"
//#include "asm/jz_mem_nand_configs/NAND_MT29F64G08CBABA.h"
...
#define CFG_NAND_ZIMAGE_OFFS	(CFG_NAND_BLOCK_SIZE*4) /* NAND offset of zImage being loaded */ //unclock for grus
 ...
 */
#define CYCLE_BEGIN_PIN	  (5 * 32 + 9)	//Begin_Key,PF9, KEY0
#define CYCLE_STOP_PIN	(5 * 32 + 10)	//Stop_Key, PF10, KEY1
...
#define GPIO_KEY_BACK			(32*5 + 9)/*GPF9 BOOT_SEL0-------grus*/
...
#define GPIO_USB_DETECT			(32*5 + 12)	/*GPF12----grus*/
...
#define GPIO_HP_DETECT			(32*4 + 9)/*GPE9 TSD3-----grus*/
#define GPIO_HP_INSERT_LEVEL	(0)

#define GPIO_HP_MUTE			(32*3 + 29)/*GPD29 UART1_RTS*/
...
#define GPIO_CTP_INT			(32*4 + 8)/*GPE8 MSC1_D0*/
#define GPIO_CTP_WAKEUP			(32*3 + 10)/*GPD10 MSC1_D1*/

#define GPIO_BT_RESET			(32*3 + 25)/*GPD25 MSC1_CMD*/
#define GPIO_BT_RESET_LEVEL		(0)

#define GPIO_BT_INT			(32*5 + 10)/*GPB5 DACK1*/
#define GPIO_BT_WAKEUP			(32*5 + 9)/*GPB4 DREQ1*/

#define GPIO_BT_POWER			(32*5 + 7)/*GPF7*/
#define GPIO_BT_POWER_LEVEL		(1)

//#define GPIO_WLAN_POWER			(32*5 + 7)/*GPF7*/
#define GPIO_WLAN_POWER			(32*3 + 8)/*GPD7*/
...
#define XBOOT_SEL_FAST_KEY             (32 * 5 + 10) //grus
...
#define LCD_RESET_PIN   	(32*3 + 11)      	/*PE11----grus*/
#define LCD_VCC_EN      	(32*4 + 9)        	/*PE9----grus*/
...
#define GPIO_FVDD_EN			(32 * 5 + 20)/*GPF20----grus*/
