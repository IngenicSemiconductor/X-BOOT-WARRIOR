...
/* DDR chip */
//#include "asm/jz_mem_nand_configs/DDR2_V59C1G02168QB-25A.h" /* 512M */
...
/* The Card controller is SD type.(Undef is MMC type ) */
...
#define CFG_CPU_SPEED		(888 * 1000000)		    /* CPU clock */
...
//#define CONFIG_BOOTARGS		"mem=192M@0x0 console=ttyS2,57600n8 ip=off root=/dev/ram0 rw rdinit=/init memcfg=512M"
 ...
 * Nand Partition info
 */
//board gps1 is not support nand boot
 ...
 * GPIO
 */
#define INVALID_PIN  			(32*5 + 31)         /* GPF31  */
...
#define GPIO_KEY_VOLUME_INC		(32*4 + 25) /*GPE25 */

#define GPIO_KEY_VOLUME_DEC		(32*3 + 18)/*GPD18 SW6*/
...
#define GPIO_CHARGE_DETECT		(32*3 + 26)/*GPC31 UART2_RST_N*/
#define GPIO_CHARGE_LEVEL		(0)

#define GPIO_USB_DETECT			(32*1 + 5)/*GPB05*/
#define GPIO_USB_INSERT_LEVEL	(0)

#define GPIO_DC_DETECT			(32*5 + 5)/*GPF05*/
#define GPIO_DC_INSERT_LEVEL	(1)

#define GPIO_AMP_ENABLE			(32*5 + 20)/*GPF20*/
#define GPIO_AMP_MUTE_LEVEL		(0)

#define GPIO_HP_DETECT			(32*5 + 21)/*GPF21*/
#define GPIO_HP_INSERT_LEVEL	(0)

#define GPIO_HP_MUTE			(32*5 + 3)/*GPF03*/
#define GPIO_HP_MUTE_LEVEL		(1)

#define GPIO_HDMI_RESET			(32*4 + 6)/*GPE6*/
#define GPIO_HDMI_ENABLE_LEVEL	(0)

#define GPIO_HDMI_INT			(32*5 + 12)/*GPF12*/
#define GPIO_HDMI_INT_LEVEL		(0)

#define GPIO_CAMERA_RESET		(32*4 + 3)/*GPE3*/
#define GPIO_CAMERA_RESET_LEVEL	(0)

#define GPIO_CAMERA_ENABLE		(32*5 + 22)/*GPF22*/
#define GPIO_CAMERA_ENABLE_LEVEL	(0)

#define GPIO_GPS_POWER_ENABLE	(32*3 + 9)/*GPD9*/
#define GPIO_GPS_POWER_LEVEL	(1)

#define GPIO_GPS_OSC_ENABLE		(32*0 + 29)/*GPA29*/
#define GPIO_GPS_OSC_LEVEL		(1)

#define GPIO_TFLASH_DETECT		(32*1 + 2)/*GPB2 SD1_CD_N*/
#define GPIO_TFLASH_INSERT_LEVEL	(1)

//#define GPIO_ECOMPASS_DRDY		(32*3 + 23)/*GPD23 MSC1_D3*/
//#define GPIO_ECOMPASS_DRDY_LEVEL	(1)

#define GPIO_GSENSOR_INT1		(32*5 + 13)/*GPF13*/
#define GPIO_GSENSOR_INT2		(32*4 + 18)/*GPE18*/

//#define GPIO_CTP_INT			(32*3 + 20)/*GPD20 MSC1_D0*/
#define GPIO_CTP_WAKEUP			(32*3 + 18)/*GPB18*/
#define GPIO_CTP_IRQ            (32*3 + 19)/*GPB19*/
#define GPIO_CTP_POW_EN         (32*3 + 23)/*PB23*/

#define GPIO_BT_RESET			(32*3 + 24)/*GPB24*/
#define GPIO_BT_RESET_LEVEL		(0)

//#define GPIO_BT_INT				(32*1 + 5)/*GPB5 DACK1*/
#define GPIO_BT_INT             (32*5 + 6) /*GPF06*/
#define GPIO_BT_WAKEUP			(32*5 + 8)/*GPF08*/
...
#define GPIO_WLAN_RESET			(32*1 + 25)/*GPB25*/
#define GPIO_WLAN_RESET_LEVEL	(0)

#define GPIO_WLAN_INT			(32*5 + 9)/*GPF09*/
#define GPIO_WLAN_WAKEUP		(32*5 + 11)/*GPF11*/
 ...
 * Battery  QYANG
 */
#define GPIO_OTG_ID_PIN		(32*5 + 18)  /*PF18  */
#define GPIO_CHARG_DETE_N   (32*2 + 31)  /* PC31*/
...
#define __charge_detect() (__battery_is_charging())

#define LOW_BATTERY_MIN 3650
#define USB_FILTER 100         
#define DC_FILTER  220        
#define DC_USB_FILTER 230
#define WINDAGE  70
/*Get the status about the vol and power on  pin if any key down return 1*/
#define __get_key_status() (__gpio_get_pin(VOL_ADD)&&__gpio_get_pin(KEY_MENU)&&(!__gpio_get_pin(KEY_BACK))&&(!__gpio_get_pin(VOL_SUB))&&__gpio_get_pin(PWR_WAKE))
...
*/
#define GPIO_SDA        (32 * 3 + 5)   //GPD5
#define GPIO_SCL        (32 * 3 + 4)    //GPD4
...
#define LCD_PWM_PIN			(32*4 + 1)			/*PE01*/
#define LCD_DITHB_PIN		GPIO_NULL
#define LCD_UD_PIN      	(32*1 + 27)       	/*PB27*/
#define LCD_LR_PIN      	(32*1 + 26)       	/*PB26*/
#define LCD_MODE_PIN  		GPIO_NULL
#define LCD_RESET_PIN   	(32*4 + 2)      	/*PE02*/
...
#define LCD_STBY_PIN		LCD_MODE_PIN
...
#define GPIO_LCD_L_R			LCD_LR_PIN	/*GPB26 control screen show left or right direction*/
#define GPIO_LCD_U_D			LCD_UD_PIN	/*GPB27 control screen show upper or down direction*/
...
#define GPIO_HDMI_INT_N                 (32*5 + 12)/*GPF12*/
#define GPIO_HDMI_DETE_N                (32*5 + 19)/*GPF19*/
 ...
 */
#define GPIO_FVDD_EN			(32*2 + 29)/*GPC29 UART2_CTS_*/
