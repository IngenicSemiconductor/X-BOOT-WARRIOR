...
#define GPIO_HDMI_RST_N				(32 * 4 + 6) //GPE06  /* HDMI reset, active low */
#define GPIO_HDMI_INT_N				(32 * 5 + 12)//GPF12  /* HDMI interrupt, active low */
#define GPIO_HDMI_HPD				(32 * 5 + 19)//GPF19  /* HDMI Hot Plug Detection */
#define GPIO_HDMI_HPD_ACTIVE_LEVEL	(0)                   /* 1: active high, 0: active low */
