...
#define CFG_CPU_SPEED_2		(1150 * 1000000)
 ...
 * Nand Partition info
 */
//board o1 is not support nand boot
...
#define GPIO_KEY_MAIN			(32*3 + 19)/*GPD19 MAIN*/
#define GPIO_KEY_VOLUME_INC		(32*3 + 17) /*GPD17 */

#define GPIO_KEY_VOLUME_DEC		(32*3 + 18)/*GPD18 SW6*/
#define GPIO_KEY_BACK			GPIO_NULL  /*GPD17 BOOT_SEL0*/
#define GPIO_KEY_MENU			GPIO_NULL
//#define GPIO_KEY_BOOT			(GPIO_KEY_BACK)/*GPD17 BOOT_SEL0*/

#define GPIO_CHARGE_DETECT		(32*5 + 2)/*GPD26 PS2_KCLK*/
#define GPIO_CHARGE_LEVEL		(0)

#define GPIO_USB_DETECT			(32*1 + 5)/*GPB5*/
...
#define GPIO_HDMI_RESET			(32*4 + 6)/*GPE6 SDAT01*/
#define GPIO_HDMI_ENABLE_LEVEL	(0)

#define GPIO_HDMI_INT			(32*5 + 12)/*GPF12 SDAT03*/
#define GPIO_HDMI_INT_LEVEL		(0)

#define GPIO_CAMERA_RESET		(32*4 + 3)/*GPE3 SSI0_CE1*/
...
#define GPIO_TFLASH_DETECT		(32*1 + 2)/*GPB2 TSD2*/
#define GPIO_TFLASH_INSERT_LEVEL	(1)

//#define GPIO_ECOMPASS_DRDY		(32*3 + 23)/*GPD23 MSC1_D3*/
//#define GPIO_ECOMPASS_DRDY_LEVEL	(1)

#define GPIO_GSENSOR_INT1		(32*5 + 13)/*GPF13 PS2_MDATA*/
#define GPIO_GSENSOR_INT2		(32*4 + 18)/*GPE18 PS2_MCLK*/

#define GPIO_CTP_INT			(32*1 + 19)/*GPB19 MSC1_D0*/
#define GPIO_CTP_WAKEUP			(32*1 + 18)/*GPB18 MSC1_D1*/
...
#define GPIO_WLAN_RESET			(32*1 + 25)/*GPB25 MSC1_CLK*/
...
//#define GPIO_CHARG_DETE_N   (32*5+2)  /* PF2*/
...
#define LOW_BATTERY_MIN 3700
#define USB_FILTER 30         
#define DC_FILTER  30        
#define DC_USB_FILTER 30 
#define WINDAGE  0
...
#define LCD_UD_PIN      	GPIO_NULL//(32*5 + 17)       	/*PF17*/
#define LCD_LR_PIN      	GPIO_NULL//(32*5 + 16)       	/*PF16*/
#define LCD_MODE_PIN  		GPIO_NULL
#define LCD_RESET_PIN   	(32*4 + 2)      	/*PE2*/
#define LCD_VCC_EN      	(32*4 + 13)        	/*PF0*/
 ...
 * gpio for HDMI 
 */
#define GPIO_HDMI_HPD                   (32*5 + 19) /*GPF19*/
