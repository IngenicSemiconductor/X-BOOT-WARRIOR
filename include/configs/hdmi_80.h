...
#define CONFIG_BOOTARGS		"mem=256M@0x0 mem=736M@0x30000000 console=ttyS3,57600n8 ip=off root=/dev/ram0 rw rdinit=/init pmem_camera=32M@0x5e000000"
...
#else
#define GPIO_KEY_VOLUME_INC		(32*3 + 18) /* vol+ K4 */
#endif
