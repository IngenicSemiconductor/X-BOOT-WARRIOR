...
/*
 * This file contains the configuration parameters for the TABLET_P2 board.
 */
...
//#define CONFIG_BOOTARGS		"mem=192M@0x0 mem=192M@0x30000000 console=ttyS1,57600n8 ip=off root=/dev/ram0 rw rdinit=/init memcfg=512M"
#else
#define CONFIG_BOOTARGS		"mem=192M console=ttyS1,57600n8 ip=off root=/dev/ram0 rw rdinit=/init memcfg=256M"
//#define CONFIG_BOOTARGS		"mem=192M@0x0 mem=192M@0x30000000 console=ttyS1,57600n8 ip=off root=/dev/ram0 rw rdinit=/init memcfg=512M"
...
#define	CFG_PROMPT		"TABLE_P2 # "	/* Monitor Command Prompt    */
...
#define PTN_RECOVERY_SIZE           ( 12 * 0x100000)
#define PTN_BOOT_SIZE               ( 12 * 0x100000)
...
#define	GPIO_TP_INT	(32 * 4 + 15)	/* GPD4 touch reset pin */

//#define GPIO_SW1                      (32*2 + 31)  /* PC31, KEY3, SW1 V2.1-2K nand*/
#define GPIO_SW1                        (32*3 + 7)  /* PD18, KEY3, SW1 V2.3-4K nand*/
#define GPIO_SW7                        (32*3 + 17)  /* PD17, BOOT_SEL0, SW7 */ 
#define GPIO_PWRWAKE                    (32*0 + 30)	 /* PA30, WKUP_N, SW11 */
//#define GPIO_DOCK_SPK_EN        (32 * 1 + 23)
//#define GPIO_DOCK_DET           (32 * 1 + 26)

#define GPIO_SPK_EN		(32 * 4 + 7)

//#define XBOOT_SEL_FAST_KEY1             GPIO_SW1
//#define XBOOT_SEL_FAST_KEY2             GPIO_USB_DETE
//#define XBOOT_SEL_FAST_KEY3             GPIO_SW1

#define XBOOT_SEL_RCVR_KEY             GPIO_SW1
 ...
 * Battery
 */
#define GPIO_USB_DETE		(32*3+13)	/* PD13 */
