...
#else
#define CONFIG_BOOTARGS		"mem=256M@0x0 mem=752M@0x30000000 console=ttyS3,57600n8 ip=off root=/dev/ram0 rw rdinit=/init pmem_camera=16M@0x5f000000 androidboot.serialno=warrior"
#endif
...
#define CFG_NAND_SMCR1          	0x14331200
...
#define PTN_SYSTEM_SIZE            ( (512 + 512) * 0x100000)
 ...
 */
#define CYCLE_BEGIN_PIN	(1 * 32 + 4)	//Begin_Key,PB4 ,KEY0
#define CYCLE_STOP_PIN	(1 * 32 + 5)	//Stop_Key, PB5, KEY1
...
#else
#define GPIO_KEY_VOLUME_INC		(32*1 + 4) /* vol+ K4 */
#endif
