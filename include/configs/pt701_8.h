...
#define CONFIG_BOOTARGS		"mem=192M@0x0 mem=192M@0x30000000 console=ttyS1,57600n8 ip=off root=/dev/ram0 rw rdinit=/init memcfg=pt701-8"
...
#define GPIO_SW1                        (32*3 + 18)  /* PD18, KEY3, SW1 V2.3-4K nand*/
