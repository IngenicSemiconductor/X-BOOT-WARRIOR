...
#define OST_CNTL		(OST_BASE+0xE4)
#define OST_CNTH		(OST_BASE+0xE8)
#define OST_CSR			(OST_BASE+0xEC)
#define OST_HBUF		(OST_BASE+0xFC)

#define REG_OST_DR		REG32(OST_DR)
#define REG_OST_CNTL            REG32(OST_CNTL)
#define REG_OST_CNTH            REG32(OST_CNTH)
#define REG_OST_CSR             REG32(OST_CSR)
#define REG_OST_HBUF            REG32(OST_HBUF)
#endif
...
#define MAX_DMA_NUM	32  /* max 12 channels */
...
#define NEMC_TGWE_WCD_MASK	(1 << 16) /* DQS Setup Time for data input start Done */
...
#define NEMC_TGPD_DPHTD_MASK(n)	(1 << ((n) - 1))
#define NEMC_TGPD_DPHTD6_MASK	(1 << 5) /* Toggle NAND Flash Data Postamble Hold Time Done Bank6 */
#define NEMC_TGPD_DPHTD5_MASK	(1 << 4)
#define NEMC_TGPD_DPHTD4_MASK	(1 << 3)
#define NEMC_TGPD_DPHTD3_MASK	(1 << 2)
#define NEMC_TGPD_DPHTD2_MASK	(1 << 1)
#define NEMC_TGPD_DPHTD1_MASK	(1 << 0)
...
#define NEMC_TGDR_RCNT_BIT	24
#define NEMC_TGDR_RCNT_MASK	(0xf << NEMC_TGDR_RCNT_BIT)
...
#define REG_DDRC_REMMAP(n)	REG32(DDRC_REMMAP(n))
...
#define SLCDC_CFG	(SLCD0_BASE + 0xA0)  /* SLCD Configure Register */
#define SLCDC_CTRL	(SLCD0_BASE + 0xA4)  /* SLCD Control Register */
#define SLCDC_STATE	(SLCD0_BASE + 0xA8)  /* SLCD Status Register */
#define SLCDC_DATA	(SLCD0_BASE + 0xAC)  /* SLCD Data Register */
...
/* Register Map Of LCDC */
#define REG_LCDC_CFG	REG32(LCD0_BASE+0x00) /* Configure Register */
#define REG_LCDC_CTRL	REG32(LCD0_BASE+0x30) /* Control Register */
#define REG_LCDC_STATE	REG32(LCD0_BASE+0x34) /* Status Register */

#define REG_LCDC_OSDC	REG32(LCD0_BASE+0x100) /* OSD Configure Register */
#define REG_LCDC_OSDCTRL	REG32(LCD0_BASE+0x104) /* OSD Control Register */
#define REG_LCDC_OSDS	REG32(LCD0_BASE+0x108) /* OSD Status Register */
#define REG_LCDC_BGC0	REG32(LCD0_BASE+0x10c) /* Background 0 Color Register */
#define REG_LCDC_BGC1	REG32(LCD0_BASE+0x24c) /* Background 1 Color Register */
#define REG_LCDC_KEY0	REG32(LCD0_BASE+0x110) /* Foreground Color Key Register 0 */
#define REG_LCDC_KEY1	REG32(LCD0_BASE+0x114) /* Foreground Color Key Register 1 */
#define REG_LCDC_ALPHA	REG32(LCD0_BASE+0x118) /* ALPHA Register */
#define REG_LCDC_IPUR	REG32(LCD0_BASE+0x11c) /* IPU Restart Register */
#define REG_LCDC_RGBC	REG32(LCD0_BASE+0x90) /* RGB Controll Register */

#define REG_LCDC_VAT	REG32(LCD0_BASE+0x0c) /* Virtual Area Setting Register */
#define REG_LCDC_DAH	REG32(LCD0_BASE+0x10) /* Display Area Horizontal Start/End Point */
#define REG_LCDC_DAV	REG32(LCD0_BASE+0x14) /* Display Area Vertical Start/End Point */

#define REG_LCDC_XYP0	REG32(LCD0_BASE+0x120) /* Foreground 0 XY Position Register */
#define REG_LCDC_XYP1	REG32(LCD0_BASE+0x124) /* Foreground 1 XY Position Register */
#define REG_LCDC_SIZE0	REG32(LCD0_BASE+0x128) /* Foreground 0 Size Register */
#define REG_LCDC_SIZE1	REG32(LCD0_BASE+0x12c) /* Foreground 1 Size Register */

#define REG_LCDC_VSYNC	REG32(LCD0_BASE+0x04) /* Vertical Synchronize Register */
#define REG_LCDC_HSYNC	REG32(LCD0_BASE+0x08) /* Horizontal Synchronize Register */
#define REG_LCDC_PS		REG32(LCD0_BASE+0x18) /* PS Signal Setting */
#define REG_LCDC_CLS	REG32(LCD0_BASE+0x1c) /* CLS Signal Setting */
#define REG_LCDC_SPL	REG32(LCD0_BASE+0x20) /* SPL Signal Setting */
#define REG_LCDC_REV	REG32(LCD0_BASE+0x24) /* REV Signal Setting */
#define REG_LCDC_IID	REG32(LCD0_BASE+0x38) /* Interrupt ID Register */
#define REG_LCDC_DA0	REG32(LCD0_BASE+0x40) /* Descriptor Address Register 0 */
#define REG_LCDC_SA0	REG32(LCD0_BASE+0x44) /* Source Address Register 0 */
#define REG_LCDC_FID0	REG32(LCD0_BASE+0x48) /* Frame ID Register 0 */
#define REG_LCDC_CMD0	REG32(LCD0_BASE+0x4c) /* DMA Command Register 0 */

#define REG_LCDC_OFFS0	REG32(LCD0_BASE+0x60) /* DMA Offsize Register 0 */
#define REG_LCDC_PW0	REG32(LCD0_BASE+0x64) /* DMA Page Width Register 0 */
#define REG_LCDC_CNUM0	REG32(LCD0_BASE+0x68) /*
				* DMA Command Counter Register 0
				* only used in smart LCD mode
				*/
#define REG_LCDC_CPOS0	REG32(LCD0_BASE+0x68) /* DMA Command and position Register 0 */
#define REG_LCDC_DESSIZE0	REG32(LCD0_BASE+0x6c) /* Foreground Size in Descriptor 0 Register*/

#define REG_LCDC_DA1	REG32(LCD0_BASE+0x50) /* Descriptor Address Register 1 */
#define REG_LCDC_SA1	REG32(LCD0_BASE+0x54) /* Source Address Register 1 */
#define REG_LCDC_FID1	REG32(LCD0_BASE+0x58) /* Frame ID Register 1 */
#define REG_LCDC_CMD1	REG32(LCD0_BASE+0x5c) /* DMA Command Register 1 */
#define REG_LCDC_OFFS1	REG32(LCD0_BASE+0x70) /* DMA Offsize Register 1 */
#define REG_LCDC_PW1	REG32(LCD0_BASE+0x74) /* DMA Page Width Register 1 */
#define REG_LCDC_CNUM1	REG32(LCD0_BASE+0x78) /*
				* DMA Command Counter Register 1
				* only used in smart LCD mode
				*/
#define REG_LCDC_CPOS1	REG32(LCD0_BASE+0x78) /* DMA Command and position Register 1 */
#define REG_LCDC_DESSIZE1	REG32(LCD0_BASE+0x7c) /* Foreground Size in Descriptor 1 Register */

#define REG_LCDC_PCFG	REG32(LCD0_BASE+0x2c0) /* Priority level threshold configure Register */
#define REG_LCDC_DUAL_CTRL	REG32(LCD0_BASE+0x2c8) /* Dual LCDC Channel Control register */

#define REG_LCDC_ENH_CFG	REG32(LCD0_BASE+0x400) /* Image inhancement CFG Register */
#define REG_LCDC_ENH_CSCCFG	REG32(LCD0_BASE+0x404) /* Color space conversion CFG Register */
#define REG_LCDC_ENH_LUMACFG	REG32(LCD0_BASE+0x408) /* LUMA CFG Register */
#define REG_LCDC_ENH_CHROCFG0	REG32(LCD0_BASE+0x40c) /* CHROMA0 CFG Register */
#define REG_LCDC_ENH_CHROCFG1	REG32(LCD0_BASE+0x410) /* CHROMA1 CFG Register */
#define REG_LCDC_ENH_DITHERCFG	REG32(LCD0_BASE+0x414) /* DITHER CFG Register */
#define REG_LCDC_ENH_STATUS	REG32(LCD0_BASE+0x418) /* Enhance status Register */
#define REG_LCDC_ENH_GAMMA	REG32(LCD0_BASE+0x800) /* GAMMA CFG Register */
#define REG_LCDC_ENH_VEE	REG32(LCD0_BASE+0x1000) /* VEE CFG Register */
...
#define BCH_ERR1	(BCH_BASE + 0x88) /* BCH Error Report 1 register */
#define BCH_ERR2	(BCH_BASE + 0x8C) /* BCH Error Report 2 register */
#define BCH_ERR3	(BCH_BASE + 0x90) /* BCH Error Report 3 register */
#define BCH_ERR4	(BCH_BASE + 0x94) /* BCH Error Report 4 register */
#define BCH_ERR5	(BCH_BASE + 0x98) /* BCH Error Report 5 register */
#define BCH_ERR6	(BCH_BASE + 0x9C) /* BCH Error Report 6 register */
#define BCH_ERR7	(BCH_BASE + 0xA0) /* BCH Error Report 7 register */
#define BCH_ERR8	(BCH_BASE + 0xA4) /* BCH Error Report 8 register */
#define BCH_ERR9	(BCH_BASE + 0xA8) /* BCH Error Report 9 register */
#define BCH_ERR10	(BCH_BASE + 0xAC) /* BCH Error Report 10 register */
#define BCH_ERR11	(BCH_BASE + 0xB0) /* BCH Error Report 11 register */
...
#define BCH_CR_DMAE		(1 << 11)  /* BCH DMA Enable */
...
#define __cpm_get_pix1div() \
	((REG_CPM_LPCDR1 & CPM_LPCDR_PIXDIV_MASK) >> CPM_LPCDR_PIXDIV_BIT)
...
#define __cpm_get_hdmidiv() \
	((REG_CPM_HDMICDR & CPM_HDMICDR_HDMIDIV_MASK) >> CPM_HDMICDR_HDMIDIV_BIT)
...
#define __cpm_set_pix1div(v) \
	(REG_CPM_LPCDR1 = (REG_CPM_LPCDR1 & ~CPM_LPCDR_PIXDIV_MASK) | ((v) << (CPM_LPCDR_PIXDIV_BIT)))
...
#define __cpm_set_hdmidiv(v) \
	(REG_CPM_HDMICDR = (REG_CPM_HDMICDR & ~CPM_HDMICDR_HDMIDIV_MASK) | ((v) << (CPM_HDMICDR_HDMIDIV_BIT)))
...
#define __cpm_select_lcdpclk_apll() 	\
	(REG_CPM_LPCDR = ((0x0 < CPM_LPCDR_LPCS_BIT) & CPM_LPCDR_LPCS_MASK) | (REG_CPM_LPCDR &(~CPM_LPCDR_LPCS_MASK)))
#define __cpm_select_lcdpclk_mpll() 	\
	(REG_CPM_LPCDR = ((0x1 < CPM_LPCDR_LPCS_BIT) & CPM_LPCDR_LPCS_MASK) | (REG_CPM_LPCDR &(~CPM_LPCDR_LPCS_MASK)))
#define __cpm_select_lcdpclk_vpll() 	\
	(REG_CPM_LPCDR = ((0x2 < CPM_LPCDR_LPCS_BIT) & CPM_LPCDR_LPCS_MASK) | (REG_CPM_LPCDR &(~CPM_LPCDR_LPCS_MASK)))
...
do {	\
	REG_CPM_LPCDR1 |= CPM_LPCDR_CELCD;	\
	while (REG_CPM_LPCDR1 & CPM_LPCDR_LCD_BUSY);	\
} while (0)
...
#define __cpm_hdmiclk_enable()	\
do {	\
	REG_CPM_HDMICDR |= CPM_HDMICDR_CEHDMI;	\
	while (REG_CPM_HDMICDR & CPM_HDMICDR_HDMI_BUSY);	\
} while (0)

#define __cpm_hdmiclk_disable()	\
do {	\
	REG_CPM_HDMICDR &= ~CPM_HDMICDR_CEHDMI;	\
	while (REG_CPM_HDMICDR & CPM_HDMICDR_HDMI_BUSY);	\
} while (0)
...
#define __cpm_select_pix1clk_ext()	(REG_CPM_LPCDR1 |= CPM_LPCDR_LPCS)
#define __cpm_select_pix1clk_pll()	(REG_CPM_LPCDR1 &= ~CPM_LPCDR_LPCS)
#define __cpm_select_pixclk_exclk()	(REG_CPM_LPCDR |= CPM_CPCCR_LSCS)
#define __cpm_select_pixclk_pll()	(REG_CPM_LPCDR &= ~CPM_LPCDR_LSCS)
#define __cpm_select_pixclk_lcd1()	(REG_CPM_LPCDR1 &= ~CPM_LPCDR_LTCS)
...
#define __cpm_stop_lcd1()	(REG_CPM_CLKGR0 |= CPM_CLKGR0_LCD1)
...
#define __cpm_start_lcd1()	(REG_CPM_CLKGR0 &= ~CPM_CLKGR0_LCD1)
...
static __inline__ unsigned int __cpm_get_xpllout(sclk sclk_name)
{
	...
	case SCLK_MPLL:
		...
		break;
	case SCLK_EPLL:
		cpxpcr = REG_CPM_CPEPCR;
		break;
	case SCLK_VPLL:
		cpxpcr = REG_CPM_CPVPCR;
		break;
	default:
	...
	if ((cpxpcr & CPM_CPXPCR_XPLLEN) && (!(cpxpcr & CPM_CPXPCR_XPLLBP))) {
...
#ifdef DUMP_MPLL
	serial_puts("mpll=");
	serial_put_dec(__cpm_get_xpllout(SCLK_MPLL));
	serial_puts("div=");
	serial_put_dec(__cpm_get_mdiv() + 1);
#endif
...
static unsigned int __cpm_get_pllout(void)
{
#if 0
...
static unsigned int cpm_get_pllout1(void)
{
#if 0
	unsigned long m, n, no, pllout,clock_in,val;
	unsigned long cppcr = REG_CPM_CPPCR1;
	unsigned long od[4] = {1, 2, 4, 8};

	if ( !(cppcr & CPM_CPPCR1_PLL1ON)) {					/* pll1 off */
    	return 0;
    }

	if (cppcr & CPM_CPPCR1_P1SCS) {
    	val = (cppcr & CPM_CPPCR1_P1SDIV_BIT) >> CPM_CPPCR1_P1SDIV_MASK;
    	clock_in = __cpm_get_pllout() / (val + 1);
    } else
    	clock_in = JZ_EXTAL;
...
#endif
/* PLL output frequency for MSC/I2S/LCD/USB */
static  unsigned int __cpm_get_pllout2(void)
{
#if 0
...
/* CPU core clock */
static  unsigned int __cpm_get_cclk(void)
{
...
static  unsigned int __cpm_get_hclk(void)
{
	int div[] = {1, 2, 3, 4, 6, 8, 12, 16, 24, 32};
...
/* Memory bus clock */
static  unsigned int __cpm_get_mclk(void)
{
	int div[] = {1, 2, 3, 4, 6, 8, 12, 16, 24, 32};
...
/* APB peripheral bus clock */
static  unsigned int __cpm_get_pclk(void)
{
	int div[] = {1, 2, 3, 4, 6, 8, 12, 16, 24, 32};
...
/* AHB1 module clock */
static  unsigned int __cpm_get_h2clk(void)
{
	int div[] = {1, 2, 3, 4, 6, 8, 12, 16, 24, 32};
...
/* LCD pixel clock */
static  unsigned int __cpm_get_pixclk(void)
{
	return __cpm_get_pllout2() / (__cpm_get_pixdiv() + 1);
}

/* I2S clock */
static  unsigned int __cpm_get_i2sclk(void)
{
	if (REG_CPM_I2SCDR & CPM_I2SCDR_I2CS) {
		return __cpm_get_pllout2() / (__cpm_get_i2sdiv() + 1);
	}
