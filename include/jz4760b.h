...
#define n(x, y)           *(volatile unsigned char *)(x) = (y)
...
#define RTC_RTCSR_OFFSET	(0x00)	/* rw, 32, 0x00000081 */
#define RTC_RTCSR	(RTC_BASE + RTC_RTCCR_OFFSET)
...
/*
 * UART3_TxD, UART3_RxD BIT12 BIT5
 */
...
do {						\
		REG_GPIO_PXFUNS(4) = 0x00000002;	\
		REG_GPIO_PXSELC(4) = 0x00000002;	\
		REG_GPIO_PXPES(4) = 0x00000002; 	\
} while (0)
