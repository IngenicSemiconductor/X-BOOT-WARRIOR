...
#define __lcd_set_backlight_level(n)					\
	do {								\
		...
		__tcu_set_full_data(LCD_PWM_CHN, JZ_EXTAL / LCD_PWM_PERIOD);	                     \
		__tcu_set_half_data(LCD_PWM_CHN, JZ_EXTAL / LCD_PWM_PERIOD * _val / (LCD_PWM_FULL)); \
...
/*
 * LCD controller stucture for JZSOC
 */
...
#ifdef CONFIG_FB_JZ4775_LCDC
extern struct jzfb_config_info jzfb1_init_data;
#endif

#endif /*jz4775_andriod_lcd.h*/
