...
void ddr_mem_init(int msel, int hl, int tsel, int arg)
{
	...
	REG_DDRC_LMR = ((DDR_EMRS1_DIC_NORMAL) << 16) | DDRC_LMR_BA_EMRS1 | DDRC_LMR_CMD_LMR | DDRC_LMR_START;
#else
...
#if defined(CONFIG_DDR2_DIFFERENTIAL)
#if defined(CONFIG_DDR2_DIC_NORMAL)
	REG_DDRC_LMR = (DDR_EMRS1_DIC_NORMAL | DDR_EMRS1_OCD_DFLT) << 16 | DDRC_LMR_BA_EMRS1 | DDRC_LMR_CMD_LMR | DDRC_LMR_START;
#else
