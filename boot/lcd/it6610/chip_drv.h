...
int ProgramSyncEmbeddedVideoMode(unsigned char VIC, unsigned char bVideoInputType) ;
#endif

#ifdef SUPPORT_DEGEN
int ProgramDEGenModeByID(MODE_ID id,unsigned char bInputSignalType) ;
#endif

int EnableVideoOutput(int HiFreq, unsigned char inputColorMode, unsigned char inputVideoType, unsigned char outputColorMode, int bHDMI) ;
int EnableAudioOutput(unsigned long VideoPixelClock, unsigned long AudioSampleClock, int ChannelNumber, int bSPDIF);
void DisableVideoOutput(void) ;
void DisableAudioOutput(void) ;
int GetEDIDData(int EDIDBlockID, unsigned char *pEDIDData);
int CheckHDMITX(unsigned char *pHPD, unsigned char *pHPDChange, unsigned char *pSysStat, unsigned char *pAudio_chk);
int EnableHDCP(int bEnable) ;
int EnableAVIInfoFrame(int bEnable, unsigned char *pAVIInfoFrame);
int EnableAudioInfoFrame(int bEnable, unsigned char *pAudioInfoFrame);
void SetAVMute(int bEnable) ;
void SetNonPCMAudio(int NLPCM) ;
...
int HDMITX_WriteI2C_Byte(unsigned char RegAddr, unsigned char Data);
int HDMITX_ReadI2C_ByteN(unsigned char RegAddr, unsigned char *pData, int N) ;
int HDMITX_WriteI2C_ByteN(unsigned char RegAddr, unsigned char *pData, int N) ;
